...
class Earthquake(object):
    ...
    def distance_to_epicenter(self, wn, element_type=mwntr.network.Node):
        """
        ...
        if element_type in [mwntr.network.Link, mwntr.network.Pipe, mwntr.network.Pump, mwntr.network.Valve]:
        ...
        elif element_type in [mwntr.network.Node, mwntr.network.Junction, mwntr.network.Tank, mwntr.network.Reservoir]:
