...
class WaterNetworkGIS:
    ...
    def _create_wn(self, append=None):
        ...
        from mwntr.network import from_dict
    ...
    def _valid_names(self, complete_list=True, truncate_names=None):
        ...
        element_objects = {
            'junctions': mwntr.network.elements.Junction,
            'tanks': mwntr.network.elements.Tank,
            'reservoirs': mwntr.network.elements.Reservoir,
            'pipes': mwntr.network.elements.Pipe,
            'pumps': mwntr.network.elements.Pump,
            'valves': mwntr.network.elements.Valve}
