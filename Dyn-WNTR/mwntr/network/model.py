...
class WaterNetworkModel(AbstractModel):
    ...
    def to_dict(self):
        ...
        dict
        """
        return mwntr.network.io.to_dict(self)
    ...
    def from_dict(self, d: dict):
        ...
        d : dict
            Dictionary representation of the WaterNetworkModel
        """
        mwntr.network.io.from_dict(d, append=self)
    ...
    def to_gis(self, crs=None, pumps_as_points=False, valves_as_points=False):
        ...
        """
        return mwntr.network.io.to_gis(self, crs, pumps_as_points, valves_as_points)
    ...
    def from_gis(self, gis_data):
        ...
        WaterNetworkModel
        """
        return mwntr.network.io.from_gis(gis_data, append=self)
    ...
    def to_graph(self, node_weight=None, link_weight=None, 
        ...
        """
        return mwntr.network.io.to_graph(self, node_weight, link_weight, 
                                        modify_direction)
