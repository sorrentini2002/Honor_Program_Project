...
import logging
from mwntr.sim import aml
import mwntr.network
import warnings
from mwntr.utils.polynomial_interpolation import cubic_spline
from mwntr.network import LinkStatus
from mwntr.sim.models.utils import ModelUpdater, Definition
...
class approx_hazen_williams_headloss_constraint(Definition):
    ...
    def build(cls, m, wn, updater, index_over=None):
        ...
        Parameters
        ----------
        m: mwntr.aml.aml.aml.Model
        wn: mwntr.network.model.WaterNetworkModel
        updater: ModelUpdater
        index_over: list of str
            list of pipe names; default is all pipes in wn
        """
    ...
    def build(cls, m, wn, updater, index_over=None):
        ...
        for link_name in index_over:
            ...
            if status == LinkStatus.Closed or link._is_isolated:
                ...
                if status is mwntr.network.LinkStatus.Active:
