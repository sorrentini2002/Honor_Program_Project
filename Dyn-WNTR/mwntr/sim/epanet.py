...
from mwntr.sim.core import WaterNetworkSimulator
from mwntr.network.io import write_inpfile
import mwntr.epanet.io
import warnings
import logging
...
class EpanetSimulator(WaterNetworkSimulator):
    ...
    def __init__(self, wn, reader=None, result_types=None):
        ...
        if self.reader is None:
            self.reader = mwntr.epanet.io.BinFile(result_types=result_types)
    ...
    def run_sim(self, file_prefix='temp', save_hyd=False, use_hyd=False, hydfile=None, 
        ...
        enData = mwntr.epanet.toolkit.ENepanet(version=version)
